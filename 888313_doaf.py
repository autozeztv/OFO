...
#==============================================================================#
 ...
 #==============================================================================#
                    ...
                    if c in [""," ","\n",None]:
                        nadya.sendMessage(msg.to,"เกิดข้อผิดพลาด..!!")
                    else:
                        wait["acomment"] = c
                        nadya.sendMessage(msg.to,"succes")

                elif msg.text.lower() == "!welcomemessage off":
                    wait['acommentOn'] = False
                    cl.sendMessage(msg.to,"➠ ปิดข้อความต้อนรับเเล้ว👌")
                elif "!leavemessage:" in msg.text.lower():
                    c = msg.text.replace("!leavemessage:","")
                    if c in [""," ","\n",None]:
                        nadya.sendMessage(msg.to,"เกิดข้อผิดพลาด..!!")
                    else:
                        wait["bcomment"] = c
                    ...
                    nadya.sendMessage(msg.to,"เปิดข้อความกล่าวถึงคนออกจากกลุ่ม")
                elif msg.text.lower() == "!leavemessage off":
                    wait['leavemessage'] = False
                   nadya.sendMessage(msg.to,"ปิดข้อความกล่าวถึงคนออกจากกลุ่ม")
