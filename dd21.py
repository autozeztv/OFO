...
wait = {
   ...
   'detectMention':True,
   'Tag':"ตั้งแทคด้วยครับ\n✍️ͲɆᎪᎷ🔝ʕ•̫͡•ʔஞ௮Ҩஆี✨",
   'message':"ระบบป้องกันรันจะทำการบล็อคคุณไว้\nหากต้องการให้ปลดกรุณาแท็กในกลุ่มบอกก่อนครับʕ•ᴥ•ʔ\n\n✍️ͲɆᎪᎷ🔝ʕ•̫͡•ʔஞ௮Ҩஆี✨"
}
...
#==============================================================================#
                    ...
                    nadya.sendMessage(msg.to,"👍เปิดระบบข้อความตอนรับเข้าʕ•ᴥ•ʔ")
                elif msg.text.lower() ==  'join off':
                    wait['acommentOn'] = False
                    nadya.sendMessage(msg.to,"👎ปิดระบบข้อความตอนรับเข้าʕ•ᴥ•ʔ")
                elif msg.text.lower() == 'leave on':
                    wait["bcommentOn"] = True
                    nadya.sendMessage(msg.to,"👍เปิดระบบข้อความตอนรับออกʕ•ᴥ•ʔ")
                elif msg.text.lower() == 'leave off':
                    wait['leavemessage'] = False
                    nadya.sendMessage(msg.to,"👎ปิดระบบข้อความตอนรับออกʕ•ᴥ•ʔ")
                elif text.lower() == 'clonecontact':
                    settings["copy"] = True
                    nadya.sendMessage(to, "👍ก็อปปี้ด้วยคอนแทคʕ•ᴥ•ʔ")
                elif msg.text in ["เชคแทค","เช็คแทค"]:
                	nadya.sendMessage(msg.to,"👍ข้อความแทคล่าสุดคือʕ•ᴥ•ʔ" + "\n\n" + "➤" + str(settings["Tag"]))
                elif msg.text in ["เชคเข้า","เช็คเข้า"]:
                	nadya.sendMessage(msg.to,"👍ข้อความตอนรับคนเข้าล่าสุดคือʕ•ᴥ•ʔ" + "\n\n" + "➤"  + str(wait["acomment"]))
                elif msg.text in ["เชคออก","เช็คออก"]:
                	nadya.sendMessage(msg.to,"👍ข้อความตอนรับคนออกล่าสุดคือʕ•ᴥ•ʔ" + "\n\n" + "➤"  + str(wait["bcomment"]))
#==============================================================================#
...
#==============================================================================#
                    ...
                    if c in [""," ","\n",None]:
                        ...
                        wait["acomment"] = c
                        nadya.sendMessage(msg.to,"👍ตั้งข้อความคนเข้าเสร็จสิ้นʕ•ᴥ•ʔ")
#==============================================================================#
                    ...
                    if c in [""," ","\n",None]:
                        ...
                        wait["bcomment"] = c
                        nadya.sendMessage(msg.to,"👍ตั้งข้อความคนออกเสร็จสิ้นʕ•ᴥ•ʔ")
#==============================================================================#
                elif text.lower() == '!แทค':
...
#==============================================================================#
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            nadya.sendMessage(to, "👍ลิ้งกลุ่มปิดอยู่ʕ•ᴥ•ʔ")
...
#==============================================================================#
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["ออน",".ออน","!ออน","\ออน",".uptime",".Uptime","!uptime","!Uptime","\Uptime","\uptime"]:
