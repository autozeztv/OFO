...
#==============================================================================#
                ...
                elif msg.text.lower() == 'wel on':
                    wait['acommentOn'] = True
                    nadya.sendMessage(msg.to,"👍เปิดข้อความต้อนรับเเล้วʕ•ᴥ•ʔ")
                elif msg.text.lower() == 'wel off':
                    wait['acommentOn'] = False
                    nadya.sendMessage(msg.to,"👎ปิดข้อความต้อนรับเเล้วʕ•ᴥ•ʔ")
                    ...
                    if c in [""," ","\n",None]:
                        ...
                        wait["acomment"] = c
                        nadya.sendMessage(msg.to,"👍ตั้งข้อความตอนรับเสร็จสิ้นʕ•ᴥ•ʔ")
